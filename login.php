	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<a href="" id="our-location" class="btn-success pull-right" data-target="#mymodal" data-toggle="modal">Login/Signup</a>
			...
			<section class=" text-center" >
				<div class="modal-dialog ">
					<div class="modal-content">
						<h3 id="login-heading">Login to IGROWTH LEARNING</h3>

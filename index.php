...
if (isset($_SESSION['username'])) {
    // The user is logged in, so display their username
    $username = $_SESSION['username'];
} else {
    // The user is not logged in, you can handle this case as needed
    header('location: login.php');
    exit; // Optionally, you can exit to prevent further execution
}
         	...
         	<div class="row">
         		<div class="col-xs-12">
         			<div class="section-title text-center">
         				<h2><b>SERVICES</b></h2>
         				<p>
         					The following services are provided by IGrowth Learning      				</p>
         			</div>
         		</div>
         	</div>
         	<div class="row">
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="online_quize/quizhome.php">Quiz's</a></h3>   <!--  exercise/exercise.php -->
         				<p>
...
<!-- 
 ...
 -->
			...
			<section class="work" id="work"><br>
				...
				<p class="text-center">join us to improve your skills</p>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<div class="sub-heading">
								<p>
									Here, you can find more data about our IGrowth Learning Website <br>
								</p>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												IGrowth Learning is an online E-learning website <br>
